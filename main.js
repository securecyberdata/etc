...
//helper functions to init elements only when they appears in viewport (jQUery.appear plugin)
    ...
    /** 
    function initMap() {
        var location = { lat: 24.937118147132566, lng: 66.9986454652719 }; // Replace with your desired location's latitude and longitude , 
    ...
    function windowLoadInit() {
        ...
        $('.related.products ul.products, .upsells.products ul.products, .cross-sells ul.products')
            ...
            .owlCarousel({
                ...
                dots: false,
                items: 3,
                navText: ['<i class="ico ico-arrow-left"></i>', '<i class="ico ico-arrow-right-alt"></i>'],
                responsive: {
                    0: {
                        items: 1
                    },
